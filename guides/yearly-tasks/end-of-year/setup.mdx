...
<Note>
While the system doesn't automatically verify these balances before starting, they are **required for successful completion**. The finalization step will verify these conditions.
</Note>
